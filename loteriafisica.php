         ...
         <div class="col-md-3" style="float:left">        
          ...
          <div class="col-md-6">
            <div class="blog-posts single-post">
              <br><br>
                <center><img src="img/lote_fisica.png"></center>
              <p class="lead">Se tiene convenio con las loterías del Tolima, Huila, Valle, Manizales, Quindío, Risaralda y Cauca. El plan de pagos es el correspondiente a cada lotería.</p>
          </div>
          </div>
          <br>
          <br>
