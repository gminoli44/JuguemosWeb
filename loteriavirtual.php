...
<!-- Page Title -->
<title>Juguemos REDCA - Loteria</title>
         ...
         <div class="col-md-3" style="float:left">        
          ...
          <div class="col-md-6">
            <div class="blog-posts single-post">
              <br><br>
              <center><img src="img/lote_virtual.png"></center>
              <p class="lead">El convenio con las loterías virtuales permite hacer apuestas a las loterías de Cauca, Valle, Quindío, Manizales, Risaralda, Meta, Tolima, Medellín, Cruz Roja y Huila. El plan de pagos es el correspondiente a cada lotería.</p>
          </div>
          </div>
          <br><br>
