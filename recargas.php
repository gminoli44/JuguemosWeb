...
<div id="wrapper">
  ...
  <div class="container">
         ...
         <div class="col-md-3" style="float:left">        
          ...
          <div class="col-md-6">
            <div class="blog-posts single-post"><br>
              <h3 class="text-theme-colored3 text-uppercase mt-50 mt-sm-0 mb-20">Recargas</h3>
              <center><img width="600px" src="img/recargas_imag.png"></center>
              <p class="lead">Servicio por medio del cual es cargado saldo de forma automática a un celular de cualquier operador prepago o postpago. Se pueden realizar esta modalidad de recargas indicándole al asesor de venta el tipo de recarga va efectuar y el valor de la misma.</p>
          </div>
          </div>
          <br><br>
