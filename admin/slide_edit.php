                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="table-responsive">
                                ...
                                <tr>
                                <?php
                                $re=mysqli_query($link,"select * from slide where id = '$id' ")or die();
                                while ($f=mysqli_fetch_array($re)) {
                                ?>
                                <form action="slide/slide_editar_ppal.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
