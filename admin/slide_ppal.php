                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Ver todos las imagenes del Slide principal</h5>
                            <a href="slide_new_ppal.php"><button style="float: right;">Agregar Nuevo</button></a>
                        </div>
                    ...
                    <?php
                    $re=mysqli_query($link,"select * from slide order by id DESC")or die();
                    while ($f=mysqli_fetch_array($re)) {
                    ?>
                                    <tbody>
                                    <tr>
                                        <td><a href="slide/Imagenes/<?php echo $f['Imagen']; ?>"><img width="200px" src="slide/Imagenes/<?php echo $f['Imagen']; ?>"></a></td>
                                        <td><?php echo $f['nombre'];?></td>    
                                        <td><?php echo $f['url'];?></td>  
                                        <td>
                                        <form action="slide/eliminar_slide_ppal.php?id=<?php echo $f['id'];?>&form=estado" method="POST">
                                          <?php if($f['estado']==1){
                                          print"
                                        ...
                                        <td><a href="slide/eliminar_slide_ppal.php?id=<?php echo $f['id'];?>" onclick="return confirm('Esta seguro que desea eliminar esta imagen?');">Eliminar</a>
                                        </td>

                                        <td><a href="slide_edit.php?id=<?php echo $f['id'];?>" >Editar</a>
                                        </td>
